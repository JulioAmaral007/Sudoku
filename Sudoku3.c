...
void resolverSudoku(int sudoku[LINHAS][COLUNAS])
{
    ...
    do
    {
        ...
        printf("Caso vc tenha finalizado aperte 'f' para verificar sua partida\n");
...
void resolucaoSudoku (int sudoku[LINHAS][COLUNAS])
{
    ...
    for (int i = 0; i < LINHAS; i++)
    {
        for (int j = 0; j < COLUNAS; j++)
        {
            if((sudoku[0][2] == 4) && (sudoku[1][2] == 2) && (sudoku[1][1] == 7) && (sudoku[2][0] == 1) && (sudoku[0][3] == 6) && (sudoku[0][5] == 8) && (sudoku[0][6] == 9) && (sudoku[0][7] == 1) && (sudoku[0][8] == 2) && (sudoku[1][6] == 3) && (sudoku[1][7] == 4) && (sudoku[1][8] == 8) && (sudoku[2][3] == 3)
                    && (sudoku[2][4] == 4) && (sudoku[2][5] == 2)&& (sudoku[2][6] == 5)&& (sudoku[2][8] == 7)&& (sudoku[3][1] == 5)&& (sudoku[3][2] == 9)&& (sudoku[3][3] == 7)&& (sudoku[3][5] == 1)&& (sudoku[3][6] == 4)&& (sudoku[3][7] == 2)&& (sudoku[4][1] == 2)&& (sudoku[4][2] == 6)&& (sudoku[4][4] == 5)
                    && (sudoku[4][6] == 7)&& (sudoku[4][7] == 9)&& (sudoku[5][1] == 1)&& (sudoku[5][2] == 3)&& (sudoku[5][3] == 9)&& (sudoku[5][5] == 4)&& (sudoku[5][6] == 8)&& (sudoku[5][7] == 5)&& (sudoku[6][0] == 9)&& (sudoku[6][2] == 1)&& (sudoku[6][3] == 5)&& (sudoku[6][4] == 3)&& (sudoku[6][5] == 7)
                    && (sudoku[6][8] == 4)&& (sudoku[7][0] == 2)&& (sudoku[7][1] == 8)&& (sudoku[7][2] == 7)&& (sudoku[7][6] == 6)&& (sudoku[7][7] == 3)&& (sudoku[8][0] == 3)&& (sudoku[8][1] == 4)&& (sudoku[8][2] == 5)&& (sudoku[8][3] == 2)&& (sudoku[8][5] == 6)&& (sudoku[8][6] == 1))
            {
